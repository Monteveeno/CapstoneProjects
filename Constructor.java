// In this we are creating a object of the Constructor
...
public class Constructor {
        ...
        public Constructor (String name, String surname, String profession, int cellPhoneNumber, int hourlyWorkRate) {
            this.name = name;
